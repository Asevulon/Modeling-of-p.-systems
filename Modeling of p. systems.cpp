...
// Modeling of p. systems.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CModelingofpsystemsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CModelingofpsystemsApp

CModelingofpsystemsApp::CModelingofpsystemsApp()
{
...
// Единственный объект CModelingofpsystemsApp

CModelingofpsystemsApp theApp;


// Инициализация CModelingofpsystemsApp

BOOL CModelingofpsystemsApp::InitInstance()
{
